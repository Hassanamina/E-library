         ...
         class test(maincode):
              ...
              def check(self):
                  ...
                  if self.var!=None:
                       ...
                       messagebox.showwarning('Warning','These Users not Registered !')
              ...
              def data(self):
                   ...
                   if self.value!=None:
                        ...
                        if self.max>=3:
                              messagebox.showerror('Library Management System','MINIMUM 3 BOOKS ARE REQUIRED!')
              ...
              def mail(self):
                    ...
                    try:
                        ...
                        print("ok")
                        messagebox.showinfo("Library ManagementSystem","Send mail Successfully !")
                    except:
                         pass
         obk=test()
         obk.issue()
         ...
         class editing(maincode):
               ...
               def search(self):
                     ...
                     if self.val!=None:
                          ...
                          self.edcat=Tk()
                          self.edcat.title("Library Management System")
                         ...
                         # -------------------insert value within edcat windows--------------------
                          ...
                          messagebox.showerror('Library Management System','PLEASE! CORRECT BOOK ID')
               ...
               def savedit(self):
                     ...
                     dd.commit()
                     messagebox.showinfo('Library Management System','YOUR DATA IS UPDATED!')
         ...
         class retu(maincode):
             ...
             def retbook(self):
                 ...
                 if self.data!=None:
                     ...
                     self.tom.title("Library Management System")
                 ...
                 #-----------------between two date calculate days---------------------
                     ...
                     messagebox.showwarning("Library Management System","YOUR ERP_ID IN NOT FOUND !")
     ...
     def delete(self):
         class dele(maincode):
               ...
               def deldata(self):
                     ...
                     if self.da!=None:
                          messagebox.showinfo('Library Management System','YOUR DATA IS DELETED !')
                     else:
                          messagebox.showerror('Library Management System','YOUR DATA IS NOT FOUND !')
         ...
         class demt(maincode):
             ...
             def srch(self):
                 ...
                 if self.srval!=None:
                     ...
                     self.top=Tk()
                     self.top.title("Digital Library")
                     ...
                     messagebox.showwarning('Library Management System','YOUR DATA IS NOT AVAILABLE !')
    ...
    #-------------------------------------------SHOW BOOKS_------------------------------------------------
     ...
     def chan_pas(self):
         ...
         if self.data!=None:
             ...
             conn.commit()
             messagebox.showinfo("Library Management System","Your Password is changed !")
